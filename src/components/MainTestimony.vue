...
<script setup>
    ...
    const testimonySlides = ref([
        ...
        {
            uniqueKey: 1,
            userPicture: '/assets/images/users/show2.jpg',
        ...
        {
            uniqueKey: 2,
            userPicture: '/assets/images/users/show3.jpg',
        ...
        {
            uniqueKey: 3,
            userPicture: '/assets/images/users/show4.jpg',
        ...
        {
            uniqueKey: 4,
            userPicture: '/assets/images/users/show5.jpg',
            userName: '주암천',
            workField: '.',
        ...
        {
            uniqueKey: 5,
            userPicture: '/assets/images/users/show6.jpg',
            userName: '곡성역 진입도로',
            workField: '.',
            commentAbout: '화단경계용으로 사용되며 곡선을 만들 수 있고 가격이 저렴해 많은 영역에서 사용가능'
        },
